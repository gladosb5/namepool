export namespace INamecoinApi {
  export interface MempoolInfo {
    ...
    mempoolminfee: number;           //  (numeric) Minimum fee rate in NMC/kB for tx to be accepted.
  ...
  export interface Vout {
    ...
    scriptPubKey: {                  //  (json object)
      ...
      address?: string;              //  (string) namecoin address
      addresses?: string[];           //  (string) namecoin addresses
  ...
  export interface AddressInformation {
    ...
    address: string;                 //  (string) The namecoin address validated
