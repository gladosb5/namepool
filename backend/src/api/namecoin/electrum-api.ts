...
class NamecoindElectrsApi extends NamecoinApi implements AbstractNamecoinApi {
  private electrumClient: any;

  constructor(namecoinClient: any) {
    super(namecoinClient);
  ...
  async $getAddress(address: string): Promise<IEsploraApi.Address> {
    const addressInfo = await this.namecoindClient.validateAddress(address);
...
export default NamecoindElectrsApi;
