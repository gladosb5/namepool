...
export class BlockSizesWeightsGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.namecoin.graphs.block-sizes:See Namecoin block sizes (MB) and block weights (weight units) visualized over time.`);
