...
@Component({
  selector: 'app-namecoin-invoice',
  templateUrl: './namecoin-invoice.component.html',
  styleUrls: ['./namecoin-invoice.component.scss'],
  standalone: false,
})
export class NamecoinInvoiceComponent implements OnInit, OnChanges, OnDestroy {
  @Input() invoice;
  @Input() redirect = true;
  @Input() minimal = false;
